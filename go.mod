...
replace (
	...
	// Our cosmos-sdk branch is:  https://github.com/osmosis-labs/cosmos-sdk disable-concurrency
	github.com/cosmos/cosmos-sdk => github.com/osmosis-labs/cosmos-sdk v0.45.1-0.20220617181839-9d6cd2da28d9
