...
replace (
	...
	// Our cosmos-sdk branch is:  https://github.com/hyehan/cosmos-sdk tag
	github.com/cosmos/cosmos-sdk => github.com/hyehan/cosmos-sdk v0.45.1-0.20220617204635-c3bf09f7ad34
